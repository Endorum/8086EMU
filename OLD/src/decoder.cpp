...
uint8_t Decoder::decode(u16 ip) {
    ...
    u8 opc = cpu->readAtIpWithOffset(0);

    current.opcode = opc;

    current.secondByte = cpu->readAtIpWithOffset(1);

    current.b2_modRegRM = cpu->readAtIpWithOffset(1);
    current.mod = (current.b2_modRegRM & 0xC0) >> 6;
    current.reg = (current.b2_modRegRM & 0x38) >> 3;
    current.rm =(current.b2_modRegRM & 0x07);    

    current.b2_DATA_8 = cpu->readAtIpWithOffset(1);
    current.b2_DATA_LO = cpu->readAtIpWithOffset(1);
    current.b2_IP_INC8 = cpu->readAtIpWithOffset(1);
    current.b2_DISP_LO = cpu->readAtIpWithOffset(1);
    current.b2_ADDR_LO = cpu->readAtIpWithOffset(1);
    current.b2_IP_INC_LO = cpu->readAtIpWithOffset(1);
    current.b2_IP_LO = cpu->readAtIpWithOffset(1);

    current.byte3 = cpu->readAtIpWithOffset(2);
    current.b3_DISP_LO = cpu->readAtIpWithOffset(2);
    current.b3_DISP_HI = cpu->readAtIpWithOffset(2);
    current.b3_DATA_8 = cpu->readAtIpWithOffset(2);
    current.b3_DATA_LO = cpu->readAtIpWithOffset(2);
    current.b3_DATA_HI = cpu->readAtIpWithOffset(2);
    current.b3_DATA_SX = cpu->readAtIpWithOffset(2);
    current.b3_ADDR_HI = cpu->readAtIpWithOffset(2);
    current.b3_IP_INC_HI = cpu->readAtIpWithOffset(2);
    current.b3_IP_HI = cpu->readAtIpWithOffset(2);

    current.byte4 = cpu->readAtIpWithOffset(3);
    current.b4_DISP_HI = cpu->readAtIpWithOffset(3);
    current.b4_DATA_HI = cpu->readAtIpWithOffset(3);
    current.b4_SEG_LO = cpu->readAtIpWithOffset(3);
    current.b4_CS_LO = cpu->readAtIpWithOffset(3);

    current.byte5 = cpu->readAtIpWithOffset(4);
    current.b5_DATA_LO = cpu->readAtIpWithOffset(4);
    current.b5_DATA_8 = cpu->readAtIpWithOffset(4);
    current.b5_DATA_SX = cpu->readAtIpWithOffset(4);
    current.b5_SEG_HI = cpu->readAtIpWithOffset(4);
    current.b5_CS_HI = cpu->readAtIpWithOffset(4);

    current.byte6 = cpu->readAtIpWithOffset(5);
    current.b6_DATA_HI = cpu->readAtIpWithOffset(5);
...
void Decoder::printInstruction() const {
    ...
    printf("| 1st Byte      | 2nd Byte | 3rd Byte | 4th Byte | 5th Byte | 6th Byte |\n");
    printf("| %02X | %s | %02X       | %02X       | %02X       | %02X       | %02X       |\n",
        current.opcode,toBinary(current.opcode).c_str(),
        current.secondByte,
        current.byte3,
        current.byte4,
        current.byte5,
        current.byte6);
    printf("| MOD: %s\n",toBinary(current.mod).c_str());
    printf("| REG: %s\n",toBinary(current.reg).c_str());
    printf("| R/M: %s\n",toBinary(current.rm).c_str());
}
